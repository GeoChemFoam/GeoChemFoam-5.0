...
public:
	...
	/**
	*  Retrieves the given surface component.
	*  @param n                The zero-based index of the component to retrieve.
	*  @return                 A null terminated string containing the given component.
	*                          Returns an empty string if n is out of range.
	*  @see                    GetSurfaceComponentCount, ListSurfaceComponents
	*/
	const char*              GetSurfaceComponent(int n);
	...
	/**
	*  Retrieves the number of surface components in the current list of components.
	*  @return                 The current count of components.
	*  @see                    GetSurfaceComponent, ListSurfaceComponents
	*/
	size_t                   GetSurfaceComponentCount(void);
	...
	/**
	*  Retrieves the current list of surface components.
	*  @return                 The current list of surface components.
	*  @see                    GetSurfaceComponent, GetSurfaceComponentCount
	*/
	std::list< std::string > ListSurfaceComponents(void);
...
#pragma warning(disable:4251)
	...
	std::list< std::string >   SurfComponents;
