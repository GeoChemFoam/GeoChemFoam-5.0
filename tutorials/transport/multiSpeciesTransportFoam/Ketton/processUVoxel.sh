...
mv 0/cellCenters constant/polyMesh/.

python writeUHdf5.py --x_min=$x_min --x_max=$x_max --y_min=$y_min --y_max=$y_max --z_min=$z_min --z_max=$z_max --res=$res --n_x=$n_x --n_y=$n_y --n_z=$n_z --n_level=$n_level 
